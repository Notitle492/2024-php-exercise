...
?>
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <input type="text" class="form-control" name="bookname" id="bookname" placeholder="請輸入書名" value="" required>
            </div>


            <div class="mb-3">
            <label for="author" class="form-label">作者：</label>
            <input type="text" class="form-control" name="author" id="author" placeholder="請輸入作者" value="" required>
            </div>


            <div class="mb-3">
            <label for="publisher" class="form-label">出版社：</label>
            <input type="text" class="form-control" name="publisher" id="publisher" placeholder="請輸入中文姓名" value="" required>
            </div>
            ...
            <input type="number" class="form-control" name="price" id="price" placeholder="請輸入定價" value="" required>
            </div>
