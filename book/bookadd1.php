...
try {
    ...
    $sql = "INSERT INTO `book` (`id`, `bookname`, `author`, `publisher`, `pubdate`, `price`, `content`) VALUES (NULL, 'Beautiful World', 'aesir', 'fffffff', '2024-04-16', '400', 'dfsdfsdfdsfrety')";
    ...
    echo "<tr><td>書名</td> <td>作者</td> <td>出版日期</td> <td>定價</td></td>";
